  ...
  return (
    <div className="flex flex-col border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow bg-white h-full">
      ...
      <div className="flex flex-col flex-1 p-3 gap-1">
        <h3 className="font-semibold text-sm line-clamp-2 text-gray-700">{product.title}</h3>
        ...
        <Link
          ...
          className="mt-2 border border-pink-600 text-pink-600 text-xs font-semibold py-2 rounded-md hover:bg-pink-50 transition-colors text-center"
        >
          Ver más
        </Link>
