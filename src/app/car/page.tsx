                    ...
                    className="flex items-center gap-3 border rounded-lg p-3 bg-white shadow-sm">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="w-7 h-7 flex items-center justify-center rounded-full text-sm hover:bg-gray-100 text-gray-500"
                            >
                                -
                            </button>
                            ...
                            className="text-red-500 text-xs font-semibold ml-2 hover:underline"
                            >
                                Eliminar
                            </button>
                        </div>
